$(function(){
    ...
    getBookList()
     ...
     $(document).on("click",".edit_show",function(){
        ...
        $("#editbook textarea[name='BookDescription']").val(edit_data.BookDescription)
    ...
    $(document).on("click","#editbook .sumbit_btn",function(){
        var params ={
            ...
            BookDescription:$("#editbook textarea[name='BookDescription']").val(),
      ...
      $(document).on("click","#addbook .sumbit_btn",function(){
        var params ={
            ...
            BookDescription:$("#addbook textarea[name='BookDescription']").val(),
        ...
        $.ajax({
            ...
            success: function(data){
              ...
              if(data.ServiceCode=="SUCCESS"){
                ...
                $("#addbook textarea[name='BookDescription']").val("")
