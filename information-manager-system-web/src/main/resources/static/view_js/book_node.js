$(function(){
    ...
    //判断切换
    function isCut(execute){
        var $modal_li = $(".modal-li")
        for(var i = 0,len = $modal_li.length;i<len;i++){
            if(!$modal_li.eq(i).is(":hidden")){
                if(confirm("不提交老的页面直接跳转嘛")){
                    execute()
                }
                return false
            }
    ...
    //伸缩
    $(document).on("click",".piece_box .book-name",function(){
        if($(this).parents(".piece_li").attr("is-open")=="false"){
            $(this).parents(".piece_li").removeAttr("is-open")
        }else{
            $(this).parents(".piece_li").attr("is-open","false")
        }
    })
        ...
        $.ajax({
            ...
            success: function(data){
                if(data.ServiceCode=="SUCCESS"){
                    ...
                    $("#head-title").find(".text").html(BookDTO.BookName)
    ...
    $(document).on("click","#add-piece-Modal .sumbit_btn",function(){
        var params = {
            ...
            BookChapterDescription:$("#add-piece-Modal textarea[name='BookChapterDescription']").val(),
        ...
        $.ajax({
            ...
            success: function(data){
                if(data.ServiceCode=="SUCCESS"){
                    ...
                    $("#add-piece-Modal textarea[name='BookChapterDescription']").val("")
    ...
    $(document).on("click",".add_piece_btn",function(){
        isCut(function(){
            $(".piece_list_box .modal-li").hide()
            $("#add-piece-Modal").show()
        })
    ...
    $(document).on("click",".edit_piece_btn",function(){
        ...
        $("#edit-piece-Modal textarea[name='BookChapterDescription']").val(eidt_BookChapterDTO.BookChapterDescription)
    ...
    $(document).on("click","#edit-piece-Modal .sumbit_btn",function(){
        var params = {
            ...
            BookChapterDescription:$("#edit-piece-Modal textarea[name='BookChapterDescription']").val(),
    ...
    $(document).on("click","#add-chapter-Modal .sumbit_btn",function(){
        var params = {
            ...
            BookSectionDescription:$("#add-chapter-Modal textarea[name='BookSectionDescription']").val(),
        ...
        $.ajax({
            ...
            success: function(data){
                if(data.ServiceCode=="SUCCESS"){
                    ...
                    $("#add-chapter-Modal textarea[name='BookSectionDescription']").val("")
    ...
    $(document).on("click",".edit_chapter_btn",function(){
        ...
        $("#edit-chapter-Modal textarea[name='BookSectionDescription']").val(edit_BookSectionDTO.BookSectionDescription)
    ...
    $(document).on("click","#edit-chapter-Modal .sumbit_btn",function(){
        var params = {
            ...
            BookSectionDescription:$("#edit-chapter-Modal textarea[name='BookSectionDescription']").val(),
